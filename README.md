...
#### *Left Half:*
The left half was built around the `HIEA + YOU` vowel block. It's the best for inrolls, as `H` comes before a vowel most of the time and makes `YOU` a 3roll. There are no other common consonants on this side to keep redirects and one-handed strings low.
