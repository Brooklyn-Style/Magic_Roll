...
as a base, I kept `HIEA` + `YOU` in place and experimented with pretty much everything else. I went through about two dozen [iterations](layout_design_progression.md "Layout Design Progression") before I had something I was happy with. My goals were to have a reasonable consonant-hand pinky and keep one-handed strings and awkward patterns to a minimum. Repeat and magic were added shortly after that, then, a few months later, I got the idea from [Hands Down Neu](https://sites.google.com/alanreiser.com/handsdown/home/hands-down-neu "Hands Down Neu") to make regular letters magic keys as well. I also took inspiration from other layouts like [Hieamtsrn](https://docs.google.com/document/d/1_a5Nzbkwyk1o0bvTctZrtgsee9jSP-6I0q3A0_9Mzm0/edit?tab=t.0#heading=h.ojttb28dodph "Hieamtsrn") for its overall design and [Magic Sturdy](https://github.com/Ikcelaks/keyboard_layouts/blob/main/magic_sturdy/magic_sturdy.md "Magic Sturdy") for its use of magic.
