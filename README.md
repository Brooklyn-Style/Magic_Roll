...
as a base, I kept `HIEA` + `YOU` in place and experimented with pretty much everything else. I went through about two dozen iterations before I had something I was happy with. My goals were to have a reasonable consonant-hand pinky, keep one-handed strings and awkward patterns to a minimum, and use repeat and magic to improve the layout further. I used the [Layout Playground](https://oxey.dev/playground/index.html "Layout Playground") analyzer and [MonkeyType's](https://monkeytype.com "MonkeyType") word filter to do just that, along with a lot of trial and error. The [Keyboard Layouts Google Doc](https://docs.google.com/document/d/1W0jhfqJI2ueJ2FNseR4YAFpNfsUM-_FlREHbpNGmC2o "Keyboard Layouts Google Doc") was also extremely useful to learn all there is to know about layout design.
