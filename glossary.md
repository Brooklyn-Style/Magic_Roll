...
- $\color{#00e1ff}{\textsf{Alt Fingering:}}$ Pressing a key with a different finger than what the homerow/touch typing method intended to avoid a SFB. $\color{violet}{\textsf{E.g.}}$ Pressing $\color{yellow}{\textsf{RG}}$ with the $\color{yellow}{\textsf{middle}}$ and $\color{yellow}{\textsf{index}}$ fingers instead of just the $\color{yellow}{\textsf{index}}$ $\color{violet}{\textsf{on Qwerty.}}$
